...
<div class="card mb-2">
  <div class="card-body">
    <h3>Balance: Php <?=format_money($totalBalance);?></h3>
    <h3>Today's budget is: Php <?=format_money($forcastedAmount);?></h3>
    <h3>Today's Expenses is: Php <?=format_money($todayExpense);?></h3>
